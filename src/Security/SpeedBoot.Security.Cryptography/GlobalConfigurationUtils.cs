...
public static class GlobalConfigurationUtils
{
    ...
    private static string _defaultAesEncryptKey = "speedbootspeedbootspeedbootspeed";
    ...
    private static string _defaultAesEncryptIv = "speedbootspeedbo";
    ...
    private static string _defaultDesEncryptKey = "speedboo";
    ...
    private static string _defaultDesEncryptIv = "speedboo";

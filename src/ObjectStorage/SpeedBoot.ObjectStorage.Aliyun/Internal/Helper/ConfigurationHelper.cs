...
internal static class ConfigurationHelper
{
    ...
    public static AliyunObjectStorageOptions GetAliyunObjectStorageOptions()
    {
        ...
        var aliyunObjectStorageOptions = App.ApplicationBuilder.GetOptions<Internal.Options.AliyunObjectStorageOptions>(aliyunObjectStorageSectionName);
        ...
        else
        {
            ...
            var aliyunOptions = App.ApplicationBuilder.GetOptions<AliyunOptions>(aliyunSectionName);

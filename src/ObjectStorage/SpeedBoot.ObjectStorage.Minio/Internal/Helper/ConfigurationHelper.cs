...
internal static class ConfigurationHelper
{
    ...
    public static MinioObjectStorageOptions GetMinioObjectStorageOptions()
    {
        ...
        var minioObjectStorageOptions = App.ApplicationBuilder.GetOptions<SpeedBoot.ObjectStorage.Minio.Internal.Options.MinioObjectStorageOptions>(minioObjectStorageSectionName);

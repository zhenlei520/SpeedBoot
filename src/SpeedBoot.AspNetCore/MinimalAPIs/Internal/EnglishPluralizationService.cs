...
internal class EnglishPluralizationService: IEnglishPluralizationService
{
    ...
    {
        SpeedArgumentException.ThrowIfNull(word);
...
#pragma warning disable S6444
    ...
    {
        SpeedArgumentException.ThrowIfNull(singular);
        SpeedArgumentException.ThrowIfNull(plural);
